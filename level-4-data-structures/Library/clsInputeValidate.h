...
public:
	...
	static template<typename T> T ReadNumber(string Message) {
		T Number;
	...
	static template<typename T> T ReadPositiveNumber(string Message) {
		T Number;
	...
	static template<typename T> ReadPositiveNumberBetween(T = short From, T = short To, string Message) {
		T PositiveNumber;
