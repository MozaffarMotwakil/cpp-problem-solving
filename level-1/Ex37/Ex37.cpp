...
void CopyArray(int ArrSource[100], int SourceArrayLength, int ArrDestination[100], int& DestinationArrayLength) {
...
int main()
{
	...
	CopyArray(ArrSource, SourceArrayLength, ArrDestination, DestinationArrayLength);
